...
Settlements (BIS, 2011), vigente internacionalmente, exige que instituições financeiras utilizem 
...
\begin{itemize}
    \item Estimar modelos GARCH(1,1) e EGARCH para a série de retornos do ativo
